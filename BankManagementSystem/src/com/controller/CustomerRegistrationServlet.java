    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                PreparedStatement ps = con.prepareStatement(insertCustomerSql);
                ...
                if (rowsAffected > 0) {
                    request.setAttribute("successMessage", " Customer creation initiated successfully with SSN " + ssnId);
                } else {
